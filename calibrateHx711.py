...
import subprocess
import time
from sharedBird import roundFlt, readPID # shared functions in shareBird.py
from configBird2 import hxDataPin, hxClckPin # import variables from ./configBird.py, but not hxOffset or hxScale because those should be this scripts result
...
s = HX711.sensor(pi, DATA=hxDataPin, CLOCK=hxClckPin, mode=HX711.CH_A_GAIN_64, callback=None) # or mode=HX711.CH_A_GAIN_128
...
print("----write values to configBirdX.py:----")
