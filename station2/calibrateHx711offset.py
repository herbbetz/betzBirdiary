...
from configBird import hxDataPin, hxClckPin, hxScale # import variables from ./configBird.py, but not hxOffset or hxScale because those should be this scripts result
