...
from configBird import hxDataPin, hxClckPin, hxScale, offsetFname # import variables from ./configBird.py, but not hxOffset, which results from this script on startup and is read in by other scripts from configBird thereafter.
