...
**BirdNET KI-Modell**
- Das BirdNET-Projekt für Vogelstimmen-Analyse stammt von der Cornell University und findet sich auf Github [BirdNET-Analyzer](https://github.com/birdnet-team/BirdNET-Analyzer).
...
- WAV-Clips von 3 sec Dauer werden in *Mel-Spektrogramme* konvertiert, das den Bild-Input für das KI-Modell bildet. Für das Training sind die WAV-Clips gelabelt, für die Anwendung entspricht jeder Output-Knoten der Logit-Wahrscheinlichkeit eines trainierten Labels.
- Die besten Ergebnisse erreicht man mit guten (USB-) Mikrophonen, mit denen auch das BirdNET seine Modelle trainiert.
- Das Trennen der Vogelstimmen (1 bis 10 kHz) von Wetter- und Verkehrslärm (< 1 kHz) erreicht man durch *band pass filter*, meist softwaremäßig (FFT), seltener elektronisch.
