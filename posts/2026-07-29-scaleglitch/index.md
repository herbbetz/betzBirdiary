...
- Die Nullinie hat eine gewisse Variation (noise), die bei Sturm zunimmt. Dieser `baseline noise` kann durch Standardabweichung (σ) ausgedrückt werden und auch zur Erhöhung der Auslöseschwelle verwendet werden: `dyn_weightThreshold = 2 * sigma + weightThreshold`.
