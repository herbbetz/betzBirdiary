You can download the version of my birdiary image from [here](https://dateicloud.de/index.php/s/6z5aBc34ZGeSSKZ). Compressed with 7-zip (https://www.7-zip.org/) it is around 830 MB. I guess, 'balena etcher' (https://etcher.balena.io/) is the simplest program to burn the uncompressed  image (5.2 GB) onto an SD card. Then use an SD card reader to view the boot partition. To there you have to copy two files (see in /image of this repo) :
