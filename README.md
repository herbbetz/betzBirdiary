...
My own image for flashing to the SD card is configured with the password: 'pi / bird24' ('bird24root' for su). You can find the installation instructions [here](image/imgInstall.html).
...
After you have found your favourite setup, you can save it to startupNoTest.sh and link startup.sh to it. Watch the code working as a beta on my [station](https://www.wiediversistmeingarten.org/view/station/87bab185-7630-461c-85e6-c04cf5bab180) and learn [more](docs/ForkMakingof.html) about my making. There is also a [troubleshooting](debug/troubleshoot.html) guide in case of issues with my software.
