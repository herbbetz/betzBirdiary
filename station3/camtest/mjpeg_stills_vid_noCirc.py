...
# Changed to import MJPEGEncoder instead of H264Encoder
...
# These are example values; you might need to adjust them based on your lighting
camsetting = {
...
def record_video(picamera, encoder, duration):
    ...
    Args:
        picamera (Picamera2): The Picamera2 instance.
        encoder (MJPEGEncoder): The encoder to use for video recording.
    ...
    # For MJPEG, Quality.MEDIUM is often used, or you can adjust
...
def main_loop():
    ...
    with Picamera2() as picam2:
        ...
        # Create video configuration for MJPEG.
        # Changed format back to YUV420, as the encoder will handle MJPEG compression.
        video_config = picam2.create_video_configuration(
            main={"size": vidsize, "format": "YUV420"}, # YUV420 is a common raw format for encoders
            transform=camera_transform # Pass the libcamera.Transform object
        )

        # Instantiate MJPEGEncoder
        ...
        # Reverted to "AeEnable": False as "ExposureMode" caused an AttributeError
        ...
        while img_count < max_stills:
            ...
            if img_count % 5 == 0:
                print("Trigger detected! Starting video recording (M-JPEG)...")
                ...
                # Changed extension from .h264 to .mjpeg
                video_name = f"video_{img_count:04d}.mjpeg"
