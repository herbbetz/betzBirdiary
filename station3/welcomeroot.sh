...
echo "| > /etc/systemd/system/bird15m.service, /etc/systemd/system/bird15m.timer" 
echo "|   systemctl list-timers bird15m.timer, journalctl -u bird15m.service"
echo "|" 
...
echo "| > /etc/sudoers (sudo visudo -> passwordless sudo)"
echo "|"
