...
IP4=$(echo $(/usr/sbin/ifconfig wlan0) | cut -d" " -f 6) # ifconfig not found immediately after reboot?
monitor[2]=$(echo $IP4); key[2]="wlan0"
...
CPULOAD=$(bash $APPDIR/cpu5sec.sh) # cpu5sec measures & blocks for 5 secs
