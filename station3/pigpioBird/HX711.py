#!/usr/bin/env python
# https://abyz.me.uk/rpi/pigpio/code/HX711_py.zip
# HX711.py
# 2018-03-05
# Public Domain
...
class sensor:
   ...
   def _callback(self, gpio, level, tick):
      ...
      if gpio == self.CLOCK:
         ...
         current_edge_long = False # added to avoid UnboundLocalError, github copilot on 2025-06-19
         if not self._paused:
...
if __name__ == "__main__":
   ...
   s = HX711.sensor(
      pi, DATA=17, CLOCK=23, mode=HX711.CH_B_GAIN_32, callback=cbf)
