...
- Neben einem Ventilator beinhaltet ein Hitzekonzept auch passive Kühlelemente und schädlingssichere Luftlöcher im [Vogelhaus](../birdhouse/birdhouse.md). Die Software muss sogenannte `tight loops (pausenlose while...continue Schleifen)` vermeiden, die einen CPU Core unproduktiv zu 100% beanspruchen können, ohne für das OS noch Pausen zu lassen.
