...
sudo touch $FLAGFILEV1		# Hardcoded for argon1v1
sudo chmod 666 $FLAGFILEV1	# Hardcoded for argon1v1
echo "true" > $FLAGFILEV1	# Hardcoded for argon1v1
...
#        CHECKDEVICE="eon"
#fi
CHECKDEVICE="fanhat"	# Hardcoded for fanhat
