...
A+ mit A- kurzschließen ist ein Standardtest für Null Input zur Hx711-Platine, die dann als digitalen Output nur ein bischen *noise* um die Null herum anzeigen sollte und andernfalls Probleme hätte mit Verdrahtung, Minus-Erdung usw.
